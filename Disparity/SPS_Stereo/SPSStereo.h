...
#include <stack>
#include <png++/png.hpp>
#include "Disparity/SPS_Stereo/defParameter.h"
...
public:
    ...
    void initSpsParameter(){
                                this->setIterationTotal(outerIterationTotal, innerIterationTotal);
                                this->setWeightParameter(lambda_pos, lambda_depth, lambda_bou, lambda_smo);
                                this->setInlierThreshold(lambda_d);
                                this->setPenaltyParameter(lambda_hinge, lambda_occ, lambda_pen);
                           }
