...
public:
    ...
    void matchFeatures(int32_t method, libviso2_Matrix *Tr_delta = 0);
...
private:
    ...
    void matching(int32_t *m1p,int32_t *m2p,int32_t *m1c,int32_t *m2c,
                  ...
                  std::vector<Matcher::p_match> &p_matched,int32_t method,bool use_prior,libviso2_Matrix *Tr_delta = 0);
